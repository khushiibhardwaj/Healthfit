...
# sample_img = cv2.imread(r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\TPose.jpg")
...
image = cv2.imread(r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\TPose.jpg")
detectPose(image, pose, display=True)

# Read another sample image and perform pose detection on it.
image = cv2.imread(r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\Tree Pose.jpg")
detectPose(image, pose, display=True)

# Read another sample image and perform pose detection on it.
image = cv2.imread(r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\Warrior II Pose.jpg")
detectPose(image, pose, display=True)
...
# List of image file paths associated with each pose
pose_images = {
    'T Pose': r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\TPose.jpg",
    'Tree Pose': r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\TreePose.jpg",
    'Warrior II Pose': r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\WarriorIIPose.jpg"
}
...
def showimg(icon):
    ...
    image = cv2.imread(r"D:\Mayank\@Project(Fit-Game)\FIT-GAME\templates\public\assets\images\TPose.jpg".format(icon)) 
...
import webbrowser
webbrowser.open("http://192.168.1.8:3000/FIT-GAME/templates/games.ejs")
